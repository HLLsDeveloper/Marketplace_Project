            ...
            <body>
                ...
                <section class="container mt-4">
                    <div class="col-lg-6 offset-lg-3">
                        ...
                        <form id="ValidacaoCampos">
                        
                        
                        
                            <div class="form-group">
                                <label for="cadastro_email">E-mail:</label>
                                <input type="email" class="form-control" name="conf_email" id="conf_email" placeholder="seuemail@seuemail.com" required>
                            </div>
                         
                            <div class="form-group">
                                <label for="confirma_email">Confirmar E-mail:</label>
                                <input type="email" class="form-control" name="email" id="email" placeholder="seuemail@seuemail.com" required>
                            </div>
                            <div class="form-group">
                                <label for="cadastro_senha">Senha:</label>
                                <input type="password" class="form-control" name="conf_senha" id="conf_senha" onchange="form.confirma_senha.pattern = this.value;" required>
                            </div>
                            ...
                            <div class="row no-gutters">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control validate " id="cpf" name="cpf" placeholder="Digite apenas números" required pattern="[0-9]+$" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <p class="text-center cadastrar_taux"><a href="CadastroJuridico.jsp">Não é pessoa física?</a></p>
                                </div>
                            </div>
                            
                            
                            <div class="form-group">
                                <label for="CadastroNM">Nome:</label>
                                <input type="text" class="form-control" name="nome" id="nome" placeholder="" required>
                            </div>
                            <div class="form-group">
                                <label for="cadaCadastroSNstro_senha">Sobrenome:</label>
                                <input type="text" class="form-control" name="sobrenome" id="sobrenome" placeholder="" required>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="cadastro_nascimento">Data nascimento:</label>
                                        <input type="text" class="form-control" name="datanascimento" id="datanascimento" placeholder="dd/mm/aaaa" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
							...
							<div class="form-row">
							 <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="cep" id="cep" placeholder="00000-000" pattern="\d{5}-?\d{3}" required>
                                </div>
                             </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="complemento" id="complemento" placeholder="Ex: 5 Andar" required>
                                </div>
                            ...
                            <br>
                            <button id="cadastrar_button" type="submit" formmethod="post" formaction="CadastroFisico" class="btn btn-lg btn-block btn-tshirt">Criar seu cadastro</button>
