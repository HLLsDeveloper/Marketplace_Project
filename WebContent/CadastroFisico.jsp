	...
	<section class="container mt-4">
		<div class="col-lg-6 offset-lg-3">
			...
			<form id="ValidacaoCampos" accept-charset="ISO-8859-1">
				...
				<div class="form-group">
					<label for="cadastro_senha">Senha:</label> <input type="password"
				...
				<div class="row no-gutters">
					<div class="col-lg-6">
						<div class="form-group">
							<label for="cadastro_cpf">CPF:</label> <input type="text"
								class="form-control validate " id="cpf" name="cpf"
								placeholder="Digite apenas números" required pattern="[0-9]+$" />
						</div>
					</div>
					<div class="col-lg-6">
				...
				<div class="form-group">
					<label for="cadaCadastroSNstro_senha">Sobrenome:</label> <input
						type="text" class="form-control" name="sobrenome" id="sobrenome"
						placeholder="" required>
				</div>
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							<label for="cadastro_nascimento">Data nascimento:</label> <input
								type="text" class="form-control" name="datanascimento"
								id="datanascimento" placeholder="dd/mm/aaaa" required>
						</div>
					</div>
					<div class="col-lg-6">
						...
						<div class="form-group">
							<div class="radio" id="sexo">
								...
								<label for="sexo_m">Masculino</label> <input type="radio"
									name="sexo" value="Feminino" required> <label
									for="sexo_f">Feminino</label>
							</div>
						</div>
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col-md-12">
						<label for="inputZip">CEP</label> <input type="text"
							class="form-control" name="cep" id="cep" placeholder="00000-000"
				...
				<div class="form-row">
					<div class="form-group col-md-3">
						<label for="inputAddress">Nº</label> <input type="text"
							...
							placeholder="Ex: 2001" required>
					</div>
					<div class="form-group col-md-3">
						<label for="inputAddress">Comp.</label> <input type="text"
				...
				<br>
				<button id="cadastrar_button" type="submit" formmethod="post"
					formaction="CadastroFisico" class="btn btn-lg btn-block btn-tshirt">Criar
					seu cadastro</button>
